...
var (
	...
	DefaultFee = sdk.NewCoin(ethermint.AttoPhoton, sdk.NewIntFromUint64(uint64(feeAmt))) // 0.01 EVMOS
)
...
func PrepareCosmosTx(
	...
	if args.GasPrice != nil {
		fees = sdk.Coins{{Denom: ethermint.AttoPhoton, Amount: args.GasPrice.MulRaw(int64(args.Gas))}}
	} else {
